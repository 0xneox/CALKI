...
#![allow(dead_code)]
use calki_ed25519::{Signature as ED_Signature, Message as ED_Message};
use calki_secp256k1::Signature;
...
mod tests {
    ...
    use calki_ed25519::{Signature, KeyPair, pubkey_to_address as ED_pubkey_to_address};
