    ...
    F: 'static,
{
    ...
    fn send_transaction(&mut self, params: Params, call_back: F) {
        self.request(method::CALKI_SEND_TRANSACTION, params, call_back)
    }

    fn get_current_height(&mut self, params: Params, call_back: F) {
        self.request(method::CALKI_BLOCK_BUMBER, params, call_back)
    }

    fn get_block_by_number(&mut self, params: Params, call_back: F) {
        self.request(method::CALKI_GET_BLOCK_BY_NUMBER, params, call_back)
    }
